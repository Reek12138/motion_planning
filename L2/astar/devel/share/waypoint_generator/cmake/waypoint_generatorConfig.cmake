...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_generator_SOURCE_PREFIX /home/reek/motion_planning/L2/astar/src/waypoint_generator)
  set(waypoint_generator_DEVEL_PREFIX /home/reek/motion_planning/L2/astar/devel)
  ...
  set(waypoint_generator_INSTALL_PREFIX /home/reek/motion_planning/L2/astar/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_generator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/reek/motion_planning/L2/astar/src/waypoint_generator/${idir}'.  ${_report}")
    endif()
